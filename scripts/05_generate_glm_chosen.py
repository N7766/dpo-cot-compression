...
Use configs/stage1_smoke_deepinfra_teacher.yaml with --max_samples for smoke
tests, and configs/stage1_generate_chosen.yaml for larger chosen-response
generation.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", default="configs/stage1_smoke_deepinfra_teacher.yaml")
